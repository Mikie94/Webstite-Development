...
{ 
alert('The password should be at least 8 characters and should include at least on number and one upper case')
return false;
}
}
</script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="profile_update.php?return=<?php echo basename($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data" name="form1" onSubmit="return CheckPassword(document.form1.password)">
